			...
			<section>
				<div>
					...
					<ol>
						...
						<li>enter a title for your item </li>
						<br />
						<li>enter a title for your description</li>
						<br />
						<li>enter price </li>
						<br />
						<li>enter a image link to update image </li>
						<br />
						<li>enter email address for more information</li>
						<br />
						<li>enter price </li>
						<br />
						<li>select a category from category dropdown</li> <br />
						<li>Click 'SAVE' to add new Item </li> <br />
						<li>
							DONE! Easy as that. Now you can view your Item on the Item page or
							on the category .
						</li>
					</ol>
